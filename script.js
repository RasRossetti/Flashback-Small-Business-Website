...
function loadStars(stars){
  ...
  for (let i = 0; i < Math.floor(stars); i++){
    calculatedStars.push(`<img src="ImgGallery/full-star.svg">`);
  }
  if(stars === 5){
  ...
  if(Number.isInteger(stars)){
    for (let i = 0; i < 5 - stars; i++){
      calculatedStars.push(`<img src="ImgGallery/empty-star.svg">`);
    }
  } else {
    calculatedStars.push(`<img src="ImgGallery/half-star.svg">`);
